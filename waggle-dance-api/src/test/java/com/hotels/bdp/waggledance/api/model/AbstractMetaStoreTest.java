...
public abstract class AbstractMetaStoreTest<T extends AbstractMetaStore> {
  ...
  public void newFederatedInstance() {
    FederatedMetaStore federatedMetaStore =
        AbstractMetaStore.newFederatedInstance(name, remoteMetaStoreUri);
  ...
  public void newPrimaryInstance() {
    ...
    PrimaryMetaStore primaryMetaStore =
        AbstractMetaStore.newPrimaryInstance(name, remoteMetaStoreUri, access);
  ...
  public void newPrimaryInstanceWithDefaultAccessControlType() {
    PrimaryMetaStore primaryMetaStore =
        AbstractMetaStore.newPrimaryInstance(name, remoteMetaStoreUri);
    assertThat(primaryMetaStore.getName(), is(name));
    assertThat(primaryMetaStore.getRemoteMetaStoreUris(), is(remoteMetaStoreUri));
  ...
  public void newPrimaryPrefixInstance() {
    ...
    PrimaryMetaStore primaryMetaStore =
        AbstractMetaStore.newPrimaryInstance(name, remoteMetaStoreUri, databasePrefix, access);
    assertThat(primaryMetaStore.getName(), is(name));
    assertThat(primaryMetaStore.getRemoteMetaStoreUris(), is(remoteMetaStoreUri));
