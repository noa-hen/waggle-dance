...
public class FederationsTest {
  ...
  @Mock private PrimaryMetaStore primaryMetaStore;
  @Mock private List<FederatedMetaStore> federatedMetaStores;
  @Mock private PrimaryMetaStore newPrimaryMetaStore;
  @Mock private List<FederatedMetaStore> newFederatedMetaStores;
