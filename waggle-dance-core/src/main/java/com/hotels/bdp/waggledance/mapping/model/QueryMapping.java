...
public interface QueryMapping {
   ...
   * @return query where database names are correctly mapped using metaStoreMapping. example 'select
   *     id from db.table' -&gt; 'select id from waggle_db.table'
