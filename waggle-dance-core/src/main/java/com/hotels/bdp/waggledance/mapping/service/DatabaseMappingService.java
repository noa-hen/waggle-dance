...
public interface DatabaseMappingService extends Closeable {
  ...
  /**
   * Checks that the table from the specified database is allowed and throws a {@link
   * NoSuchObjectException} if not.
   */
  void checkTableAllowed(String databaseName, String tableName, DatabaseMapping mapping)
