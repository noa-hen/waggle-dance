...
public class MonitoringConfiguration {
  ...
  public GraphiteMeterRegistry graphiteMeterRegistry(GraphiteConfiguration graphiteConfiguration) {
            ...
            public Duration step() {
              return Duration.ofMillis(
                  graphiteConfiguration
                      .getPollIntervalTimeUnit()
                      .toMillis(graphiteConfiguration.getPollInterval()));
            }
    ...
    HierarchicalNameMapper wdHierarchicalNameMapper =
        (id, convention) ->
    ...
    GraphiteMeterRegistry graphiteMeterRegistry =
        new GraphiteMeterRegistry(graphiteConfig, Clock.SYSTEM, wdHierarchicalNameMapper);
