...
class FederatedHMSHandler extends FacebookBase implements CloseableIHMSHandler {
  ...
  private static final String INVOCATION_LOG_NAME =
      "com.hotels.bdp.waggledance.server.invocation-log";
  ...
  private DatabaseMapping getDbMappingAndCheckTableAllowed(String dbName, String tblName)
  ...
  private DatabaseMapping checkWritePermissionsAndCheckTableAllowed(String dbName, String tblName)
      throws TException {
  ...
  private void checkWritePermissionsAndCheckTableAllowed(
      String dest_db, String dest_table_name, DatabaseMapping mapping)
      throws NoSuchObjectException {
  ...
  public void drop_database(String name, boolean deleteData, boolean cascade)
    ...
    mapping
        .getClient()
        .drop_database(mapping.transformInboundDatabaseName(name), deleteData, cascade);
  }
  ...
  public void alter_database(String dbname, Database db)
    ...
    mapping
        .getClient()
        .alter_database(
            mapping.transformInboundDatabaseName(dbname), mapping.transformInboundDatabase(db));
  }
  ...
  public List<FieldSchema> get_fields(String db_name, String table_name)
    ...
    return mapping
        .getClient()
        .get_fields(mapping.transformInboundDatabaseName(db_name), table_name);
  }
  ...
  public List<FieldSchema> get_schema(String db_name, String table_name)
    ...
    return mapping
        .getClient()
        .get_schema(mapping.transformInboundDatabaseName(db_name), table_name);
  }
  ...
  public void create_table_with_environment_context(
      Table tbl, EnvironmentContext environment_context)
      throws AlreadyExistsException,
          InvalidObjectException,
          MetaException,
          NoSuchObjectException,
    ...
    mapping
        ...
        .create_table_with_environment_context(
            mapping.transformInboundTable(tbl), environment_context);
  }
  ...
  public void create_table_with_constraints(
    ...
    databaseMapping
        ...
        .create_table_with_constraints(
            databaseMapping.transformInboundTable(tbl),
  ...
  public void drop_table_with_environment_context(
      String dbname, String name, boolean deleteData, EnvironmentContext environment_context)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(dbname, name);
    mapping
        .getClient()
        .drop_table_with_environment_context(
            mapping.transformInboundDatabaseName(dbname), name, deleteData, environment_context);
  }
  ...
  public void truncate_table(String dbName, String tableName, List<String> partNames)
    ...
    databaseMapping
        .getClient()
        .truncate_table(databaseMapping.transformInboundDatabaseName(dbName), tableName, partNames);
  }
  ...
  public List<String> get_tables(String db_name, String pattern) throws MetaException, TException {
    ...
    List<String> resultTables =
        mapping.getClient().get_tables(mapping.transformInboundDatabaseName(db_name), pattern);
  ...
  public List<String> get_all_tables(String db_name) throws MetaException, TException {
    DatabaseMapping mapping = databaseMappingService.databaseMapping(db_name);
    List<String> resultTables =
        mapping.getClient().get_all_tables(mapping.transformInboundDatabaseName(db_name));
    resultTables = databaseMappingService.filterTables(db_name, resultTables, mapping);
    return mapping.getMetastoreFilter().filterTableNames(null, db_name, resultTables);
  }
  ...
  public Table get_table(String dbname, String tbl_name)
    ...
    Table table =
        mapping.getClient().get_table(mapping.transformInboundDatabaseName(dbname), tbl_name);
    ...
    List<Table> tables =
        mapping
            ...
            .get_table_objects_by_name(
                mapping.transformInboundDatabaseName(dbname), filteredTables);
    ...
    List<String> resultTables =
        mapping
            ...
            .get_table_names_by_filter(
                mapping.transformInboundDatabaseName(dbname), filter, max_tables);
  ...
  public void alter_table(String dbname, String tbl_name, Table new_tbl)
    ...
    mapping
        .getClient()
        .alter_table(
            mapping.transformInboundDatabaseName(dbname),
            tbl_name,
  ...
  public void alter_table_with_environment_context(
      String dbname, String tbl_name, Table new_tbl, EnvironmentContext environment_context)
      throws InvalidOperationException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(dbname, tbl_name);
  ...
  public Partition add_partition(Partition new_part)
    ...
    Partition result =
        mapping.getClient().add_partition(mapping.transformInboundPartition(new_part));
  ...
  public int add_partitions(List<Partition> new_parts)
    ...
    if (!new_parts.isEmpty()) {
      ...
      // If the partitions added are for different databases in different clients that won't work
      // with waggle-dance
      DatabaseMapping mapping =
          databaseMappingService.databaseMapping(new_parts.get(0).getDbName());
      for (Partition partition : new_parts) {
        checkWritePermissionsAndCheckTableAllowed(
            partition.getDbName(), partition.getTableName(), mapping);
      }
  ...
  public int add_partitions_pspec(List<PartitionSpec> new_parts)
    ...
    if (!new_parts.isEmpty()) {
      ...
      for (PartitionSpec partitionSpec : new_parts) {
        checkWritePermissionsAndCheckTableAllowed(
            partitionSpec.getDbName(), partitionSpec.getTableName(), mapping);
      }
      return mapping
          .getClient()
          .add_partitions_pspec(mapping.transformInboundPartitionSpecs(new_parts));
    }
    return 0;
  }
  ...
  public AddPartitionsResult add_partitions_req(AddPartitionsRequest request)
      throws InvalidObjectException, AlreadyExistsException, MetaException, TException {
    DatabaseMapping mapping =
        checkWritePermissionsAndCheckTableAllowed(request.getDbName(), request.getTblName());
    ...
    Partition partition =
        mapping
            ...
            .append_partition_with_environment_context(
                mapping.transformInboundDatabaseName(db_name),
                tbl_name,
                part_vals,
                environment_context);
    ...
    Partition partition =
        mapping
            ...
            .append_partition_by_name(
                mapping.transformInboundDatabaseName(db_name), tbl_name, part_name);
    return mapping.transformOutboundPartition(partition);
  }
  ...
  public Partition append_partition_by_name_with_environment_context(
      String db_name, String tbl_name, String part_name, EnvironmentContext environment_context)
      throws InvalidObjectException, AlreadyExistsException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(db_name, tbl_name);
    Partition partition =
        mapping
  ...
  public boolean drop_partition(
    ...
    return mapping
        .getClient()
        .drop_partition(
            mapping.transformInboundDatabaseName(db_name), tbl_name, part_vals, deleteData);
  }
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public boolean drop_partition_by_name(
      String db_name, String tbl_name, String part_name, boolean deleteData)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(db_name, tbl_name);
    return mapping
        .getClient()
        .drop_partition_by_name(
            mapping.transformInboundDatabaseName(db_name), tbl_name, part_name, deleteData);
  }
  ...
  public DropPartitionsResult drop_partitions_req(DropPartitionsRequest req)
    ...
    DropPartitionsResult result =
        mapping.getClient().drop_partitions_req(mapping.transformInboundDropPartitionRequest(req));
  ...
  public Partition get_partition(String db_name, String tbl_name, List<String> part_vals)
    ...
    return mapping.transformOutboundPartition(
        mapping.getMetastoreFilter().filterPartition(partition));
  }
  ...
  public Partition exchange_partition(
      ...
      throws MetaException,
          ...
          TException {
    DatabaseMapping mapping =
        checkWritePermissionsAndCheckTableAllowed(source_db, source_table_name);
    ...
    Partition result =
        mapping
            ...
            .exchange_partition(
                partitionSpecs,
                mapping.transformInboundDatabaseName(source_db),
                source_table_name,
                mapping.transformInboundDatabaseName(dest_db),
                dest_table_name);
    return mapping.transformOutboundPartition(result);
  }
  ...
  public List<Partition> get_partitions(String db_name, String tbl_name, short max_parts)
    ...
    return mapping.transformOutboundPartitions(
        mapping.getMetastoreFilter().filterPartitions(partitions));
  }

  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME, prepend = true)
  public List<Partition> get_partitions_with_auth(
      String db_name, String tbl_name, short max_parts, String user_name, List<String> group_names)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, tbl_name);
    List<Partition> partitions =
        mapping
  ...
  public List<PartitionSpec> get_partitions_pspec(String db_name, String tbl_name, int max_parts)
    ...
    return mapping.transformOutboundPartitionSpecs(
        mapping.getMetastoreFilter().filterPartitionSpecs(partitionSpecs));
  }
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME, prepend = true)
  public List<Partition> get_partitions_ps(
    ...
    List<Partition> partitions =
        mapping
            .getClient()
            .get_partitions_ps(
                mapping.transformInboundDatabaseName(db_name), tbl_name, part_vals, max_parts);
    return mapping.transformOutboundPartitions(
        mapping.getMetastoreFilter().filterPartitions(partitions));
  }
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public List<String> get_partition_names_ps(
      String db_name, String tbl_name, List<String> part_vals, short max_parts)
      throws MetaException, NoSuchObjectException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, tbl_name);
    List<String> result =
  ...
  public List<Partition> get_partitions_by_filter(
      String db_name, String tbl_name, String filter, short max_parts)
      throws MetaException, NoSuchObjectException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, tbl_name);
    List<Partition> partitions =
        mapping
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME, prepend = true)
  public List<PartitionSpec> get_part_specs_by_filter(
      String db_name, String tbl_name, String filter, int max_parts)
      throws MetaException, NoSuchObjectException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, tbl_name);
    List<PartitionSpec> partitionSpecs =
        mapping
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME, prepend = true)
  public List<Partition> get_partitions_by_names(
      String db_name, String tbl_name, List<String> names)
      throws MetaException, NoSuchObjectException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, tbl_name);
    List<Partition> partitions =
        mapping
  ...
  public void alter_partitions(String db_name, String tbl_name, List<Partition> new_parts)
    ...
    for (Partition newPart : new_parts) {
      checkWritePermissionsAndCheckTableAllowed(
          newPart.getDbName(), newPart.getTableName(), mapping);
    }
    mapping
        .getClient()
        .alter_partitions(
  ...
  public void alter_partition_with_environment_context(
      String db_name, String tbl_name, Partition new_part, EnvironmentContext environment_context)
      throws InvalidOperationException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(db_name, tbl_name);
    checkWritePermissionsAndCheckTableAllowed(
        new_part.getDbName(), new_part.getTableName(), mapping);
    mapping
        .getClient()
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public void rename_partition(
      String db_name, String tbl_name, List<String> part_vals, Partition new_part)
      throws InvalidOperationException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(db_name, tbl_name);
    checkWritePermissionsAndCheckTableAllowed(
        new_part.getDbName(), new_part.getTableName(), mapping);
    mapping
        .getClient()
        .rename_partition(
            mapping.transformInboundDatabaseName(db_name), tbl_name, part_vals, new_part);
  }

  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public boolean partition_name_has_valid_characters(
      List<String> part_vals, boolean throw_exception) throws MetaException, TException {
  ...
  public void markPartitionForEvent(
      String db_name, String tbl_name, Map<String, String> part_vals, PartitionEventType eventType)
      throws MetaException,
          NoSuchObjectException,
          UnknownDBException,
    ...
    mapping
        ...
        .markPartitionForEvent(
            mapping.transformInboundDatabaseName(db_name), tbl_name, part_vals, eventType);
  }
  ...
  public boolean update_table_column_statistics(ColumnStatistics stats_obj)
    ...
    return mapping
        .getClient()
        .update_table_column_statistics(mapping.transformInboundColumnStatistics(stats_obj));
  }
  ...
  public boolean update_partition_column_statistics(ColumnStatistics stats_obj)
    ...
    return mapping
        .getClient()
        .update_partition_column_statistics(mapping.transformInboundColumnStatistics(stats_obj));
  }

  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public ColumnStatistics get_table_column_statistics(
      String db_name, String tbl_name, String col_name)
      throws NoSuchObjectException,
          MetaException,
          InvalidInputException,
          InvalidObjectException,
  ...
  public ColumnStatistics get_partition_column_statistics(
      String db_name, String tbl_name, String part_name, String col_name)
      throws NoSuchObjectException,
          MetaException,
          InvalidInputException,
          InvalidObjectException,
  ...
  public TableStatsResult get_table_statistics_req(TableStatsRequest request)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping mapping =
        getDbMappingAndCheckTableAllowed(request.getDbName(), request.getTblName());
    return mapping
        .getClient()
        .get_table_statistics_req(mapping.transformInboundTableStatsRequest(request));
  }
  ...
  public PartitionsStatsResult get_partitions_statistics_req(PartitionsStatsRequest request)
    ...
    return mapping
        .getClient()
        .get_partitions_statistics_req(mapping.transformInboundPartitionsStatsRequest(request));
  }
  ...
  public AggrStats get_aggr_stats_for(PartitionsStatsRequest request)
    ...
    return mapping
        .getClient()
        .get_aggr_stats_for(mapping.transformInboundPartitionsStatsRequest(request));
  }
  ...
  public boolean set_aggr_stats_for(SetPartitionsStatsRequest request)
    ...
    if (!request.getColStats().isEmpty()) {
      DatabaseMapping mapping =
          databaseMappingService.databaseMapping(
              request.getColStats().get(0).getStatsDesc().getDbName());
      for (ColumnStatistics stats : request.getColStats()) {
        checkWritePermissionsAndCheckTableAllowed(
            stats.getStatsDesc().getDbName(), stats.getStatsDesc().getTableName(), mapping);
      }
      return mapping
          .getClient()
          .set_aggr_stats_for(mapping.transformInboundSetPartitionStatsRequest(request));
    }
    return false;
  }
  ...
  public PrincipalPrivilegeSet get_privilege_set(
      HiveObjectRef hiveObject, String user_name, List<String> group_names)
      throws MetaException, TException {
    DatabaseMapping mapping;
    ...
    return mapping
        .getClient()
        .get_privilege_set(
            mapping.transformInboundHiveObjectRef(hiveObject), user_name, group_names);
  }
  ...
  public List<HiveObjectPrivilege> list_privileges(
    ...
    List<HiveObjectPrivilege> privileges =
        mapping
            .getClient()
            .list_privileges(
                principal_name, principal_type, mapping.transformInboundHiveObjectRef(hiveObject));
  ...
  public boolean revoke_privileges(PrivilegeBag privileges) throws MetaException, TException {
    if (privileges.isSetPrivileges() && !privileges.getPrivileges().isEmpty()) {
      ...
      return mapping
          .getClient()
          .revoke_privileges(mapping.transformInboundPrivilegeBag(privileges));
    }
    return false;
  }
  ...
  public GrantRevokePrivilegeResponse grant_revoke_privileges(GrantRevokePrivilegeRequest request)
    ...
    if (privilegesBag.isSetPrivileges() && !privilegesBag.getPrivileges().isEmpty()) {
      ...
      return mapping
          .getClient()
          .grant_revoke_privileges(mapping.transformInboundGrantRevokePrivilegesRequest(request));
    }
  ...
  public GrantRevokePrivilegeResponse refresh_privileges(
    ...
    return databaseMapping
        .getClient()
        .refresh_privileges(
            databaseMapping.transformInboundHiveObjectRef(hiveObjectRef),
            authorizer,
            databaseMapping.transformInboundGrantRevokePrivilegesRequest(
                grantRevokePrivilegeRequest));
  }

  private DatabaseMapping checkWritePermissionsForPrivileges(PrivilegeBag privileges)
      throws NoSuchObjectException {
    DatabaseMapping mapping =
        databaseMappingService.databaseMapping(
            privileges.getPrivileges().get(0).getHiveObject().getDbName());
  ...
  public List<String> set_ugi(String user_name, List<String> group_names)
    ...
    return databaseMappingService
        ...
        .setUgi(user_name, group_names, mappings);
  }
  ...
  public String get_delegation_token(String token_owner, String renewer_kerberos_principal_name)
    ...
    try {
      return saslServerWrapper
          ...
          .getDelegationToken(
              token_owner, renewer_kerberos_principal_name, getIPAddressFromSaslServer());
  ...
  public long renew_delegation_token(String token_str_form) throws MetaException, TException {
    try {
      return saslServerWrapper.getDelegationTokenManager().renewDelegationToken(token_str_form);
    } catch (IOException e) {
      throw new MetaException(e.getMessage());
    } catch (Exception e) {
  ...
  public void cancel_delegation_token(String token_str_form) throws MetaException, TException {
    try {
      saslServerWrapper.getDelegationTokenManager().cancelDelegationToken(token_str_form);
    } catch (IOException e) {
      throw new MetaException(e.getMessage());
    } catch (Exception e) {
      throw newMetaException(e);
  ...
  public void repl_tbl_writeid_state(ReplTblWriteIdStateRequest replTblWriteIdStateRequest)
    ...
    databaseMapping
        ...
        .repl_tbl_writeid_state(
            databaseMapping.transformInboundReplTblWriteIdStateRequest(replTblWriteIdStateRequest));
  }
  ...
  public AllocateTableWriteIdsResponse allocate_table_write_ids(
    ...
    DatabaseMapping databaseMapping =
        checkWritePermissions(allocateTableWriteIdsRequest.getDbName());
    return databaseMapping
        .getClient()
        .allocate_table_write_ids(
            databaseMapping.transformInboundAllocateTableWriteIdsRequest(
  ...
  public void add_dynamic_partitions(AddDynamicPartitions rqst)
      throws NoSuchTxnException, TxnAbortedException, TException {
    DatabaseMapping mapping =
        checkWritePermissionsAndCheckTableAllowed(rqst.getDbname(), rqst.getTablename());
  ...
  public void add_foreign_key(AddForeignKeyRequest req)
    ...
    databaseMapping
        .getClient()
        .add_foreign_key(databaseMapping.transformInboundAddForeignKeyRequest(req));
  }
  ...
  public void add_unique_constraint(AddUniqueConstraintRequest addUniqueConstraintRequest)
    ...
    databaseMapping
        ...
        .add_unique_constraint(
            databaseMapping.transformInboundAddUniqueConstraintRequest(addUniqueConstraintRequest));
  }
  ...
  public void add_not_null_constraint(AddNotNullConstraintRequest addNotNullConstraintRequest)
    ...
    databaseMapping
        ...
        .add_not_null_constraint(
            databaseMapping.transformInboundAddNotNullConstraintRequest(
  ...
  public void add_default_constraint(AddDefaultConstraintRequest addDefaultConstraintRequest)
    ...
    databaseMapping
        ...
        .add_default_constraint(
            databaseMapping.transformInboundAddDefaultConstraintRequest(
  ...
  public void add_check_constraint(AddCheckConstraintRequest addCheckConstraintRequest)
    ...
    databaseMapping
        ...
        .add_check_constraint(
            databaseMapping.transformInboundAddCheckConstraintRequest(addCheckConstraintRequest));
  }
  ...
  public void alter_table_with_cascade(
      String dbname, String tbl_name, Table new_tbl, boolean cascade)
      throws InvalidOperationException, MetaException, TException {
    DatabaseMapping mapping = checkWritePermissionsAndCheckTableAllowed(dbname, tbl_name);
    checkWritePermissionsAndCheckTableAllowed(new_tbl.getDbName(), new_tbl.getTableName(), mapping);
    mapping
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public CacheFileMetadataResult cache_file_metadata(CacheFileMetadataRequest req)
      throws TException {
    DatabaseMapping mapping = databaseMappingService.primaryDatabaseMapping();
    checkWritePermissionsAndCheckTableAllowed(req.getDbName(), req.getTblName());
    return mapping
        .getClient()
        .cache_file_metadata(mapping.transformInboundCacheFileMetadataRequest(req));
  }
  ...
  public WMGetAllResourcePlanResponse get_all_resource_plans(
      WMGetAllResourcePlanRequest wmGetAllResourcePlanRequest) throws MetaException, TException {
  ...
  public void alter_ischema(AlterISchemaRequest alterISchemaRequest)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping databaseMapping =
        checkWritePermissions(alterISchemaRequest.getName().getDbName());
    checkWritePermissions(alterISchemaRequest.getNewSchema().getDbName());
    databaseMapping
        .getClient()
        .alter_ischema(databaseMapping.transformInboundAlterISchemaRequest(alterISchemaRequest));
  }
  ...
  public ISchema get_ischema(ISchemaName iSchemaName)
    ...
    ISchema result =
        databaseMapping
            .getClient()
            .get_ischema(databaseMapping.transformInboundISchemaName(iSchemaName));
  ...
  public void drop_ischema(ISchemaName iSchemaName)
    ...
    databaseMapping
        .getClient()
        .drop_ischema(databaseMapping.transformInboundISchemaName(iSchemaName));
  }
  ...
  public void add_schema_version(SchemaVersion schemaVersion)
    ...
    databaseMapping
        .getClient()
        .add_schema_version(databaseMapping.transformInboundSchemaVersion(schemaVersion));
  }
  ...
  public SchemaVersion get_schema_version(SchemaVersionDescriptor schemaVersionDescriptor)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping databaseMapping =
        checkWritePermissions(schemaVersionDescriptor.getSchema().getDbName());
    SchemaVersion result =
        databaseMapping
            .getClient()
            .get_schema_version(
                databaseMapping.transformInboundSchemaVersionDescriptor(schemaVersionDescriptor));
  ...
  public SchemaVersion get_schema_latest_version(ISchemaName iSchemaName)
    ...
    SchemaVersion result =
        databaseMapping
            .getClient()
            .get_schema_latest_version(databaseMapping.transformInboundISchemaName(iSchemaName));
    return databaseMapping.transformOutboundSchemaVersion(result);
  }
  ...
  public List<SchemaVersion> get_schema_all_versions(ISchemaName iSchemaName)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping databaseMapping = checkWritePermissions(iSchemaName.getDbName());
    List<SchemaVersion> result =
        databaseMapping
            .getClient()
            .get_schema_all_versions(databaseMapping.transformInboundISchemaName(iSchemaName));
  ...
  public FindSchemasByColsResp get_schemas_by_cols(FindSchemasByColsRqst findSchemasByColsRqst)
      throws MetaException, TException {
    DatabaseMapping databaseMapping = databaseMappingService.primaryDatabaseMapping();
    FindSchemasByColsResp result =
        databaseMapping.getClient().get_schemas_by_cols(findSchemasByColsRqst);
  ...
  public void map_schema_version_to_serde(
    ...
    databaseMapping
        ...
        .map_schema_version_to_serde(
            databaseMapping.transformInboundMapSchemaVersionToSerdeRequest(
  ...
  public void set_schema_version_state(SetSchemaVersionStateRequest setSchemaVersionStateRequest)
    ...
    databaseMapping
        ...
        .set_schema_version_state(
            databaseMapping.transformInboundSetSchemaVersionStateRequest(
  ...
  public List<RuntimeStat> get_runtime_stats(GetRuntimeStatsRequest getRuntimeStatsRequest)
      throws MetaException, TException {
    DatabaseMapping databaseMapping = databaseMappingService.primaryDatabaseMapping();
    List<RuntimeStat> result =
        databaseMapping.getClient().get_runtime_stats(getRuntimeStatsRequest);
    return result;
  }
  ...
  public void drop_constraint(DropConstraintRequest req)
      throws NoSuchObjectException, MetaException, TException {
    DatabaseMapping mapping =
        checkWritePermissionsAndCheckTableAllowed(req.getDbname(), req.getTablename());
  ...
  public NotificationEventsCountResponse get_notification_events_count(
    ...
    DatabaseMapping databaseMapping =
        getDbMappingAndCheckTableAllowed(
            notificationEventsCountRequest.getDbName(),
            notificationEventsCountRequest.getCatName());
    NotificationEventsCountResponse result =
        databaseMapping
            .getClient()
            .get_notification_events_count(
                databaseMapping.transformInboundNotificationEventsCountRequest(
  ...
  public List<FieldSchema> get_fields_with_environment_context(
      String db_name, String table_name, EnvironmentContext environment_context)
      throws MetaException, UnknownTableException, UnknownDBException, TException {
    DatabaseMapping mapping = getDbMappingAndCheckTableAllowed(db_name, table_name);
    return mapping
        .getClient()
        .get_fields_with_environment_context(
            mapping.transformInboundDatabaseName(db_name), table_name, environment_context);
  }
  ...
  public UniqueConstraintsResponse get_unique_constraints(
    ...
    DatabaseMapping databaseMapping =
        getDbMappingAndCheckTableAllowed(
            uniqueConstraintsRequest.getDb_name(), uniqueConstraintsRequest.getTbl_name());
    UniqueConstraintsResponse result =
        databaseMapping
            .getClient()
  ...
  public NotNullConstraintsResponse get_not_null_constraints(
    ...
    DatabaseMapping databaseMapping =
        getDbMappingAndCheckTableAllowed(
            notNullConstraintsRequest.getDb_name(), notNullConstraintsRequest.getTbl_name());
    NotNullConstraintsResponse result =
        databaseMapping
            .getClient()
            .get_not_null_constraints(
                databaseMapping.transformInboundNotNullConstraintsRequest(
  ...
  public DefaultConstraintsResponse get_default_constraints(
    ...
    DatabaseMapping databaseMapping =
        getDbMappingAndCheckTableAllowed(
            defaultConstraintsRequest.getDb_name(), defaultConstraintsRequest.getTbl_name());
    DefaultConstraintsResponse result =
        databaseMapping
            .getClient()
            .get_default_constraints(
                databaseMapping.transformInboundDefaultConstraintsRequest(
  ...
  public CheckConstraintsResponse get_check_constraints(
    ...
    DatabaseMapping databaseMapping =
        getDbMappingAndCheckTableAllowed(
            checkConstraintsRequest.getDb_name(), checkConstraintsRequest.getTbl_name());
    CheckConstraintsResponse result =
        databaseMapping
            .getClient()
  ...
  public int get_num_partitions_by_filter(String db_name, String tbl_name, String filter)
    ...
    return mapping
        ...
        .get_num_partitions_by_filter(
            mapping.transformInboundDatabaseName(db_name), tbl_name, filter);
  }
  ...
  public PrimaryKeysResponse get_primary_keys(PrimaryKeysRequest request)
      throws MetaException, NoSuchObjectException, TException {
    DatabaseMapping mapping =
        getDbMappingAndCheckTableAllowed(request.getDb_name(), request.getTbl_name());
  ...
  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public List<TableMeta> get_table_meta(
      String db_patterns, String tbl_patterns, List<String> tbl_types) throws MetaException {
    return databaseMappingService
        .getPanopticOperationHandler()
  ...
  public List<String> get_tables_by_type(String db_name, String pattern, String tableType)
    ...
    return mapping
        .getMetastoreFilter()
        .filterTableNames(null, mapping.transformInboundDatabaseName(db_name), result);
  }
  ...
  public List<String> get_materialized_views_for_rewriting(String dbName)
    ...
    return databaseMapping
        .getClient()
        .get_materialized_views_for_rewriting(databaseMapping.transformInboundDatabaseName(dbName));
  }
  ...
  public GetTableResult get_table_req(GetTableRequest req)
    ...
    GetTableResult result =
        mapping.getClient().get_table_req(mapping.transformInboundGetTableRequest(req));
  ...
  public GetTablesResult get_table_objects_by_name_req(GetTablesRequest req)
    ...
    List<String> filteredTables =
        databaseMappingService.filterTables(req.getDbName(), req.getTblNames(), mapping);
  ...
  public Materialization get_materialization_invalidation_info(
    ...
    return databaseMapping
        ...
        .get_materialization_invalidation_info(
            databaseMapping.transformInboundCreationMetadata(creationMetadata), validTxnList);
  }

  @Override
  @Loggable(value = Loggable.DEBUG, skipResult = true, name = INVOCATION_LOG_NAME)
  public void update_creation_metadata(
      String catName, String dbName, String tableName, CreationMetadata creationMetadata)
      throws MetaException, InvalidOperationException, UnknownDBException, TException {
    DatabaseMapping databaseMapping = getDbMappingAndCheckTableAllowed(dbName, tableName);
    databaseMapping
        .getClient()
        .update_creation_metadata(
            catName,
            databaseMapping.transformInboundDatabaseName(dbName),
            tableName,
            creationMetadata);
  }
