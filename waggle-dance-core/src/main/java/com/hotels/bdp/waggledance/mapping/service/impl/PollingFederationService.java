...
public class PollingFederationService {
  ...
  private static final String METASTORE_STATUS_METRIC_NAME = "metastore_status";
  private static final String METASTORE_TAG_NAME = "metastore";
  ...
  private void sendMetric(String metastoreName, MetaStoreStatus status) {
    ...
    Counter counter =
        Counter.builder(METASTORE_STATUS_METRIC_NAME)
