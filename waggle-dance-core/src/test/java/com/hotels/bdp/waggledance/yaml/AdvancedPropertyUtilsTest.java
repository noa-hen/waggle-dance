...
public class AdvancedPropertyUtilsTest {
  ...
  @Test
  public void createUnwriteablePropertySet()
      throws IntrospectionException, NoSuchFieldException, SecurityException {
    Set<Property> properties =
        propertyUtils.createPropertySet(UnwriteableTestBean.class, BeanAccess.DEFAULT);
  ...
  @Test
  public void createUnreadablePropertySet()
      throws NoSuchFieldException, SecurityException, IntrospectionException {
    Set<Property> properties =
        propertyUtils.createPropertySet(UnreadableTestBean.class, BeanAccess.DEFAULT);
    assertThat(properties.size(), is(0));
  }
}
