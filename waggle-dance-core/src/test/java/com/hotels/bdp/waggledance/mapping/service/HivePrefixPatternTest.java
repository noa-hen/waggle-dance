...
public class HivePrefixPatternTest {
  ...
  public void hivePrefixPatternMatchDp() {
    ...
    checkMatched(
        matched, false, false, false, false, false, false, true, false, false, false, false, false);

    matched = HivePrefixPattern.matchDp(PREFIX, "wa.....sgdyu");
    checkMatched(
        matched, false, false, false, false, false, false, false, true, false, false, false, false,
        false);

    matched = HivePrefixPattern.matchDp(PREFIX, "wa.**.sgdyu");
    checkMatched(
        matched, false, false, false, false, true, true, true, false, false, false, false, false);

    matched = HivePrefixPattern.matchDp(PREFIX, "wa.**....sgdyu");
    checkMatched(
        matched, false, false, false, false, true, true, true, true, true, true, false, false,
        false, false, false);

    matched = HivePrefixPattern.matchDp("", "wa.**....sgdyu");
    checkMatched(
        matched, true, false, false, false, false, false, false, false, false, false, false, false,
        false, false, false);

    matched = HivePrefixPattern.matchDp("", "*wa.**....sgdyu");
    checkMatched(
        matched, true, true, false, false, false, false, false, false, false, false, false, false,
  ...
  public void hivePrefixPattern() {
    ...
    hivePrefixPattern = new HivePrefixPattern(PREFIX, "wa.**....sgdyu");
    assertEquals(
        Arrays.asList("**....sgdyu", "*....sgdyu", "...sgdyu", "..sgdyu", ".sgdyu", "sgdyu"),
        hivePrefixPattern.getSubPatterns());

    hivePrefixPattern = new HivePrefixPattern("", "wa.**....sgdyu");
    assertEquals(Arrays.asList("wa.**....sgdyu"), hivePrefixPattern.getSubPatterns());

    hivePrefixPattern = new HivePrefixPattern("", "*wa.**....sgdyu");
    assertEquals(
        Arrays.asList("*wa.**....sgdyu", "*wa.**....sgdyu"), hivePrefixPattern.getSubPatterns());

    hivePrefixPattern = new HivePrefixPattern(PREFIX, "*waggle_*...sgdyu");
    assertEquals(
        Arrays.asList("*waggle_*...sgdyu", "*...sgdyu", "*...sgdyu"),
        hivePrefixPattern.getSubPatterns());

    hivePrefixPattern = new HivePrefixPattern(PREFIX, "waggl*...sgdyu");
    assertEquals(
        Arrays.asList("*...sgdyu", "..sgdyu", ".sgdyu"), hivePrefixPattern.getSubPatterns());
