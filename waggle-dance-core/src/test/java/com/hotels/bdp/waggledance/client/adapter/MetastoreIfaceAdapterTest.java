...
/**
 * Fully are this doesn't comes even close to full test coverage. Lots of methods are rather trivial
 * and fairly useless to add, just add when needed. Some basic methods have been added that are
 * needed as a start.
 */
